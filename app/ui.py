...
with st.form("prediction_form"):
    ...
    with col2:
        ...
        situacion_vivienda = st.selectbox(
            ...
            options=["ALQUILER", "PROPIA", "HIPOTECA", "OTROS"])
    ...
    with col4:
        ...
        duracion_credito = st.number_input("Duración del crédito (años)", min_value=1.0, value=3.0)
    ...
    with col6:
        ...
        antiguedad_cliente = st.number_input("Antigüedad cliente", min_value=0.0, value=36.0)
        limite_credito_tc = st.number_input("Límite de crédito tarjeta", min_value=0.0, value=10000.0)
    ...
    with col7:
        gastos_ult_12m = st.number_input("Gastos últimos 12 meses", min_value=0.0, value=1200.0)
    
    with col8:
        operaciones_ult_12m = st.number_input("Operaciones últimos 12 meses", min_value=1.0, value=36.0)
...
if submit_button:
    ...
    gasto_promedio_operacion = gastos_ult_12m / operaciones_ult_12m
